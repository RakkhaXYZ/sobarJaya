          ...
          <div className="flex">
              <div className="w-1/3">
                  ...
                  <ul>
                      ...
                      <a href="/dsosmed1"><li className="bg-[#22467d] text-[#ffffff] text-xl font-semibold font-['Poppins'] p-2 mb-2 w-[304px] h-[43px]"><i className="fab fa-twitter mr-2"></i>Twitter X</li></a>
                      <li> <div className="w-[300px] h-[2px] bg-gray-300"></div></li>
