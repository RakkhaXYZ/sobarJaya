  ...
  return (
    ...
    <main className="w-[1090px] h-[107px] bg-white shadow p-2">
       <header className="flex justify-between items-center mb-6">
        ...
        <section className="bg-[#f4f6f9] p-6 rounded ">
                            <div className="flex">
                                <div className="w-1/3">
                                    <div className="bg-[#22467d] text-white text-2xl font-semibold font-['Poppins'] p-2 mb-4 w-[304px] h-[43px]">Media Sosial</div>
                                    <ul>
                                        <a href=""><li className="bg-[#22467d] text-white text-xl font-semibold font-['Poppins'] p-2 mb-2 w-[304px] h-[43px]"><i className="fab fa-facebook mr-2"></i>Facebook</li></a>
                                        <li className="text-[#3c3c3c] text-xl font-semibold font-['Poppins'] p-2 mb-2"><i className="fab fa-twitter mr-2"></i>Twitter X</li>
                                        <li className="text-[#3c3c3c] text-xl font-semibold font-['Poppins'] p-2 mb-2 p-2 mb-2"><i className="fab fa-youtube mr-2"></i>Youtube</li>
                                        <li className="text-[#3c3c3c] text-xl font-semibold font-['Poppins'] p-2 mb-2 p-2 mb-2"><i className="fab fa-instagram mr-2"></i>Instagram</li>
                                    </ul>
                                </div>
