        ...
        <div className="flex justify-start items-center ">
          <div className="bg-[#f4f6f9] p-6 rounded-lg  flex w-[1300px]">
            <div className="flex flex-col items-center mr-8">
              ...
              <div className="w-[174px] h-[30px] text-black text-2xl font-semibold font-['Poppins']">
                Master Admin
              </div>
            </div>
            <div className="flex flex-col">
              <div className="mb-4">
                <div className="w-[131px] h-[29px] text-[#22467d] text-xl font-semibold font-['Poppins']">
                  Identitas Diri
                </div>
                <div className="mt-2">
                  <div className="w-[184px] h-[29px] text-black text-xl font-semibold font-['Poppins']">
                    Nama
                  </div>
                  <input
                    type="text"
                    className="mt-1 p-2 border border-gray-300 rounded w-[516px] h-[37px] bg-[#f4f2f2]"
                  />
                </div>
              </div>
              <br />
              <hr className="my-4" />
              <div>
                <div className="w-[171px] h-[29px] text-[#22467d] text-xl font-semibold font-['Poppins']">
                  Ganti Kata sandi
                </div>
                <div className="mt-2">
                  <div className="w-[184px] h-[29px] text-black text-xl font-semibold font-['Poppins']">
